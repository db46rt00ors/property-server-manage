<template>
  <a-row class="content">
    <a-form :form="form" :labelCol="labelCol" :wrapperCol="wrapperCol">
      ...
      <a-row>
        <a-col :span="8">
          <a-form-item label="停租日期(自)">
            <a-date-picker></a-date-picker>
          </a-form-item>
        </a-col>
        <a-col :span="8">
          <a-form-item label="停租日期(至)">
            <a-date-picker></a-date-picker>
          </a-form-item>
        </a-col>
        <a-col :span="8">
...
<script>
import parkinginformationEdit from './contractmanagement.edit/edit'
const columns = [
    {
        width: '18%',
        align: 'center',
    ...
    { align: 'center', title: '签订日期', dataIndex: 'signing_date', key: 'signing_date' },
...
export default {
    ...
    methods: {
        ...
        edit(record) {
            ...
            this.parkinginformationobj.record = record
        }
    },
    components: {
